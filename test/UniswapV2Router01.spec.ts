...
enum RouterVersion {
  SnackswapRouter01 = 'SnackswapRouter01',
  SnackswapRouter02 = 'SnackswapRouter02'
}

describe('SnackswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.SnackswapRouter01]: fixture.router01,
        [RouterVersion.SnackswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SnackswapRouter01]: 101876,
              [RouterVersion.SnackswapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SnackswapRouter01]: 138770,
              [RouterVersion.SnackswapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
